...
rm /data/data/com.termux/files/usr/etc/apt/sources.list.d/*
...
sed -i '86 {s/^/#/};96 {s/^/#/}' /data/data/com.termux/files/usr/lib/ruby/gems/3.2.0/gems/concurrent-ruby-1.2.2/lib/concurrent-ruby/concurrent/atomic/thread_local_var.rb
sed -i '442, 476 {s/^/#/};436, 438 {s/^/#/}' $PREFIX/lib/ruby/gems/3.2.0/gems/logging-2.3.1/lib/logging/diagnostic_context.rb
